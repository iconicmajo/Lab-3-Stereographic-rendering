...
green = Material(diffuse = color(139, 150, 18),albedo = (0.6, 0.3, 0.1), spec = 5)
red = Material(diffuse = color(224, 47, 16),albedo = (0.6, 0.3, 0.1), spec = 5)
...
carrot = Material(diffuse = color(227, 110, 14), albedo = (0.6, 0.3, 0.1), spec = 15)
